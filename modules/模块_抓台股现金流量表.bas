Attribute VB_Name = "模块_抓台股现金流量表"
Option Explicit

' =================================================================
'  抓台股 Cash Flow Statement — FinMind
'  写入 Sheet: 台股_现金流量表
' =================================================================

Public Sub Main()
    RunTWStatement "CashFlow", "台股_现金流量表", GetTWCFConcepts(), 8
End Sub


Private Function GetTWCFConcepts() As Variant
