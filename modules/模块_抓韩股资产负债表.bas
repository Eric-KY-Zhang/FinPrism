Attribute VB_Name = "模块_抓韩股资产负债表"
Option Explicit

' =================================================================
'  抓韩股 Balance Sheet — Phase 4d
'  写入 Sheet: 韩股_资产负债表
' =================================================================

Public Sub Main()
    RunKRStatement "BalanceSheet", "韩股_资产负债表", GetKRBSConcepts(), 8
End Sub


Private Function GetKRBSConcepts() As Variant
